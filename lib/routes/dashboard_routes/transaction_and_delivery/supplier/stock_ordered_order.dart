...
class StockOrderedOrderSupplier extends StatefulWidget {
  final String transcode;
  final List<Medicine> medicines;
  const StockOrderedOrderSupplier({required this.transcode, required this.medicines, Key? key}) : super(key: key);

  @override
  State<StockOrderedOrderSupplier> createState() => _StockOrderedOrderSupplierState();
}

class _StockOrderedOrderSupplierState extends State<StockOrderedOrderSupplier> {
