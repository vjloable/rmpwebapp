...
List<String> admin_password = ['','1234','1234','1234'];
...
List<String> user_name = ['user','Iligan 1','Iligan 2','Kapatagan','Maranding','Aurora'];

class AuthService{
  Map<String,String> signIn(String emailAddress, String password, String session) {
    ...
    if(session == 'admin'){
      ...
      if(isFound && (user_password.elementAt(elem) == password)){
